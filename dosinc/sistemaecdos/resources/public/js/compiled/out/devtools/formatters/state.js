...
var len__25923__auto___60206 = arguments.length;
var i__25924__auto___60207 = (0);
while(true){
if((i__25924__auto___60207 < len__25923__auto___60206)){
args__25930__auto__.push((arguments[i__25924__auto___60207]));

var G__60208 = (i__25924__auto___60207 + (1));
i__25924__auto___60207 = G__60208;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25931__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq60204){
var G__60205 = cljs.core.first.call(null,seq60204);
var seq60204__$1 = cljs.core.next.call(null,seq60204);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__60205,seq60204__$1);
});
...
return (p1__60209_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1489464079972