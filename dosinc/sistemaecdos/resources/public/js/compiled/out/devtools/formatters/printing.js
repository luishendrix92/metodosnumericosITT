...
var len__25923__auto___60215 = arguments.length;
var i__25924__auto___60216 = (0);
while(true){
if((i__25924__auto___60216 < len__25923__auto___60215)){
args__25930__auto__.push((arguments[i__25924__auto___60216]));

var G__60217 = (i__25924__auto___60216 + (1));
i__25924__auto___60216 = G__60217;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25931__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq60212){
var G__60213 = cljs.core.first.call(null,seq60212);
var seq60212__$1 = cljs.core.next.call(null,seq60212);
var G__60214 = cljs.core.first.call(null,seq60212__$1);
var seq60212__$2 = cljs.core.next.call(null,seq60212__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__60213,G__60214,seq60212__$2);
});
...
if(cljs.core.truth_((function (){var or__24848__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25454__auto__,writer__25455__auto__,opt__25456__auto__){
return cljs.core._write.call(null,writer__25455__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__24836__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__24836__auto__){
var or__24848__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__24848__auto__)){
return or__24848__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__60218_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__60218_SHARP_));
})))){
...
var map__60227 = opts;
var map__60227__$1 = ((((!((map__60227 == null)))?((((map__60227.cljs$lang$protocol_mask$partition0$ & (64))) || (map__60227.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60227):map__60227);
var markup_db = cljs.core.get.call(null,map__60227__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__24848__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e60231){var e__37683__auto__ = e60231;
return false;
}})();
if(cljs.core.truth_(or__24848__auto__)){
return or__24848__auto__;
...
}catch (e60233){var e__37683__auto__ = e60233;
return false;
}}
})())){
...
var _STAR_current_state_STAR_60238 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__60239 = opts;
var map__60239__$1 = ((((!((map__60239 == null)))?((((map__60239.cljs$lang$protocol_mask$partition0$ & (64))) || (map__60239.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60239):map__60239);
var markup_db = cljs.core.get.call(null,map__60239__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_60238;
}});
...
;
var temp__4655__auto___60244 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___60244)){
var managed_print_level_60245 = temp__4655__auto___60244;
var _STAR_print_level_STAR_60243_60246 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_60245;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_60243_60246,managed_print_level_60245,temp__4655__auto___60244,writer,opts,job_fn){
return (function (p1__60241_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__60241_SHARP_,null);
});})(_STAR_print_level_STAR_60243_60246,managed_print_level_60245,temp__4655__auto___60244,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_60243_60246;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1489464080109