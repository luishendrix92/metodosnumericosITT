...
var and__24836__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__24836__auto__){
var or__24848__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e60646){var e__37683__auto__ = e60646;
return false;
...
}catch (e60648){var e__37683__auto__ = e60648;
return false;
...
}catch (e60654){var e__37683__auto__ = e60654;
return false;
...
}catch (e60656){var e__37683__auto__ = e60656;
return false;
...
}catch (e60662){var e__37683__auto__ = e60662;
return false;
}})())){
...
}catch (e60664){var e__37683__auto__ = e60664;
return false;
}})())){
...
var _STAR_current_state_STAR_60667 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__24848__auto__ = config;
if(cljs.core.truth_(or__24848__auto__)){
return or__24848__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_60667;
}});
});
...
return (function() { 
var G__60670__delegate = function (args){
...
var G__60670 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__60671__i = 0, G__60671__a = new Array(arguments.length -  0);
while (G__60671__i < G__60671__a.length) {G__60671__a[G__60671__i] = arguments[G__60671__i + 0]; ++G__60671__i;}
  args = new cljs.core.IndexedSeq(G__60671__a,0);
} 
return G__60670__delegate.call(this,args);};
G__60670.cljs$lang$maxFixedArity = 0;
G__60670.cljs$lang$applyTo = (function (arglist__60672){
var args = cljs.core.seq(arglist__60672);
return G__60670__delegate(args);
});
G__60670.cljs$core$IFn$_invoke$arity$variadic = G__60670__delegate;
return G__60670;
})()
;
});
...
var pre_handler = (function (){var or__24848__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__24848__auto__)){
return or__24848__auto__;
} else {
...
var post_handler = (function (){var or__24848__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__24848__auto__)){
return or__24848__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1489464081020