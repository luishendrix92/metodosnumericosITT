...
return (new CustomEvent(event_name,(function (){var obj54608 = {"detail":data};
return obj54608;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__24836__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__24836__auto__)){
var and__24836__auto____$1 = (window["CustomEvent"]);
...
var args54613 = [];
var len__25923__auto___54619 = arguments.length;
var i__25924__auto___54620 = (0);
while(true){
if((i__25924__auto___54620 < len__25923__auto___54619)){
args54613.push((arguments[i__25924__auto___54620]));

var G__54621 = (i__25924__auto___54620 + (1));
i__25924__auto___54620 = G__54621;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54613.length)].join('')));
...
var f = (function (){var pred__54616 = cljs.core._EQ_;
var expr__54617 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__54616.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__54617))){
return ((function (pred__54616,expr__54617){
return (function (p1__54609_SHARP_){
return console.warn(p1__54609_SHARP_);
});
;})(pred__54616,expr__54617))
} else {
if(cljs.core.truth_(pred__54616.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__54617))){
return ((function (pred__54616,expr__54617){
return (function (p1__54610_SHARP_){
return console.debug(p1__54610_SHARP_);
});
;})(pred__54616,expr__54617))
} else {
if(cljs.core.truth_(pred__54616.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__54617))){
return ((function (pred__54616,expr__54617){
return (function (p1__54611_SHARP_){
return console.error(p1__54611_SHARP_);
});
;})(pred__54616,expr__54617))
} else {
return ((function (pred__54616,expr__54617){
return (function (p1__54612_SHARP_){
return console.log(p1__54612_SHARP_);
});
;})(pred__54616,expr__54617))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__54623){
var map__54626 = p__54623;
var map__54626__$1 = ((((!((map__54626 == null)))?((((map__54626.cljs$lang$protocol_mask$partition0$ & (64))) || (map__54626.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54626):map__54626);
var opts = map__54626__$1;
var eval_fn = cljs.core.get.call(null,map__54626__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__54628_SHARP_);
});})(new_def))
);
...
return (function (p__54629){
var vec__54630 = p__54629;
var ky = cljs.core.nth.call(null,vec__54630,(0),null);
var v = cljs.core.nth.call(null,vec__54630,(1),null);
...
var args54633 = [];
var len__25923__auto___54636 = arguments.length;
var i__25924__auto___54637 = (0);
while(true){
if((i__25924__auto___54637 < len__25923__auto___54636)){
args54633.push((arguments[i__25924__auto___54637]));

var G__54638 = (i__25924__auto___54637 + (1));
i__25924__auto___54637 = G__54638;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54633.length)].join('')));
...
if(cljs.core.truth_((function (){var and__24836__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1489464071964