...
var map__39335 = top_item;
var map__39335__$1 = ((((!((map__39335 == null)))?((((map__39335.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39335.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39335):map__39335);
var file = cljs.core.get.call(null,map__39335__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__39335__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__39335__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e39334){var _e = e39334;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___39337 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___39337)){
var seen_errors_39338 = temp__4655__auto___39337;
if(cljs.core.truth_(seen_errors_39338.has(self))){
} else {
seen_errors_39338.add(self);

var temp__4657__auto___39339 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___39339)){
var sense_39340 = temp__4657__auto___39339;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_39340)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1491541658142