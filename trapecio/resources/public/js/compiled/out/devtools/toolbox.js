...
var args39047 = [];
var len__25923__auto___39053 = arguments.length;
var i__25924__auto___39054 = (0);
while(true){
if((i__25924__auto___39054 < len__25923__auto___39053)){
args39047.push((arguments[i__25924__auto___39054]));

var G__39055 = (i__25924__auto___39054 + (1));
i__25924__auto___39054 = G__39055;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox39050 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox39050 = (function (obj,header,style,tag,meta39051){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox39050.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39052,meta39051__$1){
var self__ = this;
var _39052__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox39050(self__.obj,self__.header,self__.style,self__.tag,meta39051__$1));
});

devtools.toolbox.t_devtools$toolbox39050.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39052){
var self__ = this;
var _39052__$1 = this;
return self__.meta39051;
});

devtools.toolbox.t_devtools$toolbox39050.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox39050.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox39050.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox39050.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox39050.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta39051","meta39051",228473767,null)], null);
});

devtools.toolbox.t_devtools$toolbox39050.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox39050.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox39050";

devtools.toolbox.t_devtools$toolbox39050.cljs$lang$ctorPrWriter = (function (this__25454__auto__,writer__25455__auto__,opt__25456__auto__){
return cljs.core._write.call(null,writer__25455__auto__,"devtools.toolbox/t_devtools$toolbox39050");
});

devtools.toolbox.__GT_t_devtools$toolbox39050 = (function devtools$toolbox$__GT_t_devtools$toolbox39050(obj__$1,header__$1,style__$1,tag__$1,meta39051){
return (new devtools.toolbox.t_devtools$toolbox39050(obj__$1,header__$1,style__$1,tag__$1,meta39051));
});

}

return (new devtools.toolbox.t_devtools$toolbox39050(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1491541657590