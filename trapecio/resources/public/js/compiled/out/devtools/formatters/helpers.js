...
var G__38524 = devtools.prefs.pref.call(null,v);
v = G__38524;
continue;
} else {
return v;
...
}catch (e38537){var e__38233__auto__ = e38537;
return false;
}})();
...
}catch (e38541){var e__38233__auto__ = e38541;
return false;
}})();
...
}catch (e38543){var e__38233__auto__ = e38543;
return false;
}}
}
});
...
var vec__38548 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38548,(0),null);
var name = cljs.core.nth.call(null,vec__38548,(1),null);
...
return cljs.core.some.call(null,(function (p1__38551_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38551_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1491541656386