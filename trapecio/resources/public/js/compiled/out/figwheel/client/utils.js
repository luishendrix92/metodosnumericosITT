...
return (new CustomEvent(event_name,(function (){var obj32226 = {"detail":data};
return obj32226;
})()));
} else {
...
var args32231 = [];
var len__25923__auto___32237 = arguments.length;
var i__25924__auto___32238 = (0);
while(true){
if((i__25924__auto___32238 < len__25923__auto___32237)){
args32231.push((arguments[i__25924__auto___32238]));

var G__32239 = (i__25924__auto___32238 + (1));
i__25924__auto___32238 = G__32239;
continue;
} else {
}
break;
...
var f = (function (){var pred__32234 = cljs.core._EQ_;
var expr__32235 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32234.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32235))){
return ((function (pred__32234,expr__32235){
return (function (p1__32227_SHARP_){
return console.warn(p1__32227_SHARP_);
});
;})(pred__32234,expr__32235))
} else {
if(cljs.core.truth_(pred__32234.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32235))){
return ((function (pred__32234,expr__32235){
return (function (p1__32228_SHARP_){
return console.debug(p1__32228_SHARP_);
});
;})(pred__32234,expr__32235))
} else {
if(cljs.core.truth_(pred__32234.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32235))){
return ((function (pred__32234,expr__32235){
return (function (p1__32229_SHARP_){
return console.error(p1__32229_SHARP_);
});
;})(pred__32234,expr__32235))
} else {
return ((function (pred__32234,expr__32235){
return (function (p1__32230_SHARP_){
return console.log(p1__32230_SHARP_);
});
;})(pred__32234,expr__32235))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32241){
var map__32244 = p__32241;
...
var opts = map__32244__$1;
var eval_fn = cljs.core.get.call(null,map__32244__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
args32251.push((arguments[i__25924__auto___32255]));
...
//# sourceMappingURL=utils.js.map?rel=1491541646165