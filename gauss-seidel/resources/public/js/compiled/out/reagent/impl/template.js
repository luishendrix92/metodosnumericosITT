...
var G__26594 = o;
(G__26594[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__26602 = jsprops;
(G__26602["defaultValue"] = value);

(G__26602["onChange"] = ((function (G__26602,v,value,on_change){
return (function (p1__26600_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26600_SHARP_);
});})(G__26602,v,value,on_change))
);
...
var vec__26609 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26609,(0),null);
var id = cljs.core.nth.call(null,vec__26609,(1),null);
var class$ = cljs.core.nth.call(null,vec__26609,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26614 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26614 == null)){
} else {
var key_26615 = temp__4661__auto___26614;
(jsprops["key"] = key_26615);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26617 = (new reagent.impl.template.NativeWrapper());
(G__26617["name"] = c);
...
var len__25923__auto___26623 = arguments.length;
var i__25924__auto___26624 = (0);
while(true){
if((i__25924__auto___26624 < len__25923__auto___26623)){
args__25930__auto__.push((arguments[i__25924__auto___26624]));

var G__26625 = (i__25924__auto___26624 + (1));
i__25924__auto___26624 = G__26625;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26621){
var G__26622 = cljs.core.first.call(null,seq26621);
var seq26621__$1 = cljs.core.next.call(null,seq26621);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26622,seq26621__$1);
});
...
break;
default:
var G__26629 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26629;
continue;
...
var n__25763__auto___26632 = a.length;
var i_26633 = (0);
while(true){
if((i_26633 < n__25763__auto___26632)){
(a[i_26633] = reagent.impl.template.as_element.call(null,(a[i_26633])));

var G__26634 = (i_26633 + (1));
i_26633 = G__26634;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25763__auto___26635 = a.length;
var i_26636 = (0);
while(true){
if((i_26636 < n__25763__auto___26635)){
var val_26637 = (a[i_26636]);
if((cljs.core.vector_QMARK_.call(null,val_26637)) && ((reagent.impl.template.key_from_vec.call(null,val_26637) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26636] = reagent.impl.template.as_element.call(null,val_26637));

var G__26638 = (i_26636 + (1));
i_26636 = G__26638;
continue;
} else {
}
...
var ctx = ({});
var vec__26642 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26642,(0),null);
var derefed = cljs.core.nth.call(null,vec__26642,(1),null);
...
var G__26646 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26646) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26646){
...
//# sourceMappingURL=template.js.map?rel=1489628676979