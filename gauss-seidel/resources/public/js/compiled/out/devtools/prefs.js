...
var len__25923__auto___38251 = arguments.length;
var i__25924__auto___38252 = (0);
while(true){
if((i__25924__auto___38252 < len__25923__auto___38251)){
args__25930__auto__.push((arguments[i__25924__auto___38252]));

var G__38253 = (i__25924__auto___38252 + (1));
i__25924__auto___38252 = G__38253;
continue;
} else {
}
break;
...
return (function (p1__38245_SHARP_){
return (p1__38245_SHARP_ === sentinel);
});})(rmaps,sentinel))
;
...
return (function (p1__38246_SHARP_){
return cljs.core.get.call(null,p1__38246_SHARP_,key,sentinel);
});})(result,todo_keys,key,rmaps,sentinel,sentinel_QMARK_,merged_keys))
,rmaps)));
var G__38254 = cljs.core.assoc.call(null,result,key,val);
var G__38255 = cljs.core.rest.call(null,todo_keys);
result = G__38254;
todo_keys = G__38255;
continue;
}
...
devtools.prefs.simple_merge.cljs$lang$applyTo = (function (seq38247){
var G__38248 = cljs.core.first.call(null,seq38247);
var seq38247__$1 = cljs.core.next.call(null,seq38247);
return devtools.prefs.simple_merge.cljs$core$IFn$_invoke$arity$variadic(G__38248,seq38247__$1);
});
...
devtools.prefs.update_pref_BANG_.cljs$lang$applyTo = (function (seq38256){
var G__38257 = cljs.core.first.call(null,seq38256);
var seq38256__$1 = cljs.core.next.call(null,seq38256);
var G__38258 = cljs.core.first.call(null,seq38256__$1);
var seq38256__$2 = cljs.core.next.call(null,seq38256__$1);
return devtools.prefs.update_pref_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38257,G__38258,seq38256__$2);
});


//# sourceMappingURL=prefs.js.map?rel=1489628698413