...
var G__38588 = devtools.prefs.pref.call(null,v);
v = G__38588;
continue;
} else {
return v;
...
}catch (e38601){var e__38297__auto__ = e38601;
return false;
}})();
...
}catch (e38605){var e__38297__auto__ = e38605;
return false;
}})();
...
}catch (e38607){var e__38297__auto__ = e38607;
return false;
}}
}
});
...
var vec__38612 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38612,(0),null);
var name = cljs.core.nth.call(null,vec__38612,(1),null);
...
return cljs.core.some.call(null,(function (p1__38615_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38615_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1489628699492